				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							...
							<form class="comment_form" method="post" action="mahasiswaEditSave.php">
                                <?php
								include "koneksi.php";
								...
								<div>
									...
									<input name="txtnosiswa" type="text" id="txtnosiswa" class="comment_input" required="required" value="<?php echo $data["no_siswa"];?>">
								</div>
								<div>
									<div class="form_title">Tahun Angkatan</div>
									<input name="txttahunangkatan" type="text" id="txttahunangkatan" class="comment_input" required="required" value="<?php echo $data["tahun_angkatan"];?>">
								</div>
								<div>
                                ...
                                <div>
									<input name="txtid" type="hidden" id="txtid" value="<?php echo $data['id_siswa'];?>" class="comment_input" required="required" placeholder="061801">
                                </div>
								<div>
