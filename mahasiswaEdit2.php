					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								...
								<div class="shopping_cart"><a href="Login php/act-logout.php"><i class="fa fa-users" aria-hidden="true"></i></a></i></div>
				...
				<div class="row">
					<div class="col">
						<div class="breadcrumbs">
							<ul>
								<li><a href="Login php/act-logout.php">Home</a></li>
								<li>Halaman Admin</li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							...
							<form class="comment_form" method="post" action="mahasiswaEditSave2.php">
                                <?php
								include "koneksi.php";
								...
								<div>
									...
									<input name="txtnopendaftaran" type="text" id="txtnopendaftaran" class="comment_input" required="required" value="<?php echo $data["no_pendaftaran"];?>">
								</div>
								<div>
									<div class="form_title">Jurusan</div>
									<input name="txtjurusan" id="txtjurusan" class="comment_input" required="required" value="<?php echo $data["kd_jurusan"];?>">
                                </div>
                                <div>
									<div class="form_title">No Ijazah</div>
									<input name="txtnoijazah" type="text" id="txtnoijazah" class="comment_input" required="required" value="<?php echo $data["no_ijazah"];?>">
								</div>
								<div>
                                ...
                                <div>
									...
									<input name="txttahunlulus" type="text" id="txttahunlulus" value="<?php echo $data['tahun_lulus'];?>" class="comment_input" required="required" placeholder="2018">
                                </div>
                                <div>
									<div class="form_title">Tanggal Daftar</div>
									<input name="txttanggaldaftar" type="date" id="txttanggaldaftar" value="<?php echo $data['tgl_daftar'];?>" class="comment_input" required="required" placeholder="2000/01/13">
                                </div>
                                <div>
                                ...
                                <div>
									<input name="txtid" type="hidden" id="txtid" value="<?php echo $data['id'];?>" class="comment_input" required="required" placeholder="061801">
                                </div>
								<div>
