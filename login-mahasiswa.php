				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Masuk untuk mendaftar</div>
							<form class="comment_form" method="post" action="Login php/act-mahasiswa.php?op=in">
								<div>
								...
								<div>
                                <div class="form_title">Belum punya akun ? Daftar <a href="daftar-mahasiswa.php">disini</a></div>
									<input type="submit" name="Submit" class="comment_button trans_200" value="Masuk">
								</div>
							</form>
						</div>
					</div>
