	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="pendaftaran.html">Pendaftaran</a></li>
			</ul>
		</nav>
	</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Masuk ke Sistem Administrasi</div>
							<form class="comment_form" method="post" action="Login php/act-login.php?op=in">
								<div>
