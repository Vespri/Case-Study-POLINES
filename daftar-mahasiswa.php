...
<title>Register Pendaftaran</title>
<meta charset="utf-8">
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="about.html">Tentang Kami</a></li>
				<li class="menu_mm"><a href="jurusan.html">Jurusan</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Register untuk mendaftar</div>
							<form class="comment_form" method="post" action="register.php">
								<div>
									<div class="form_title">Username</div>
									<input name="nama" type="text" id="nama" class="comment_input" required="required" placeholder="Username Anda">
                                </div>
                                <div>
									<div class="form_title">User ID</div>
									<select name="userid" id="userid" class="comment_input">
                                        <option value="BLANK">...</option>
                                        <option>Calon Mahasiswa</option>
                                    </select>
								</div>
								<div>
									<div class="form_title">Password</div>
									<input name="password" type="password" id="password" class="comment_input" required="required" placeholder="Password">
								</div>
								<div>
									<input type="submit" name="Submit" class="comment_button trans_200" value="Register">
								</div>
							</form>
						</div>
					</div>
								...
								<div class="footer_section footer_links">
									...
									<div class="footer_links_container">
										<ul>
											...
											<li><a href="jurusan.html">Jurusan</a></li>
											<li><a href="daftar_mahasiswa.php">Pendaftaran</a></li>
										</ul>
									</div>
								</div>
