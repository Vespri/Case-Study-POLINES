					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								...
								<div class="shopping_cart"><a href="login.php"><i class="fa fa-users" aria-hidden="true"></i></a></div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Nilai Anda Sudah Berhasil Dikirim</div>
							<form class="comment_form" method="post" action="hasil.php">
								<div>
									<input type="submit" name="Submit" class="comment_button trans_200" value="Lihat Hasil">
								</div>
							</form>
						</div>
					</div>
...
if($_POST){
    ...
    $nilai_bhs_ing = $_POST['nilai_bhs_ing'];
    $nilai_mtk = $_POST['nilai_mtk'];
	$nilai_ipa = $_POST['nilai_ipa'];
	$nilai_ips = $_POST['nilai_ips'];
    $nilai_uan = $_POST['nilai_uan'];
    if(trim($no_pendaftaran) == ""){
        echo "Nomor pendaftaran masih kosong, isi dengan benar";
    }
    elseif (trim($nilai_agama) == ""){
        echo "Nilai belum diisi, isi dengan benar";
    }
    elseif (trim($nilai_bhs_indo) == ""){
        echo "Nilai belum diisi, isi dengan benar";
    }
    elseif (trim($nilai_bhs_ing) == ""){
        echo "Nilai belum diisi, isi dengan benar";
    }
    elseif (trim($nilai_mtk) == ""){
        echo "Nilai belum diisi, isi dengan benar";
    }
    elseif (trim($nilai_ipa) == ""){
		echo "Nilai belum diisi, isi dengan benar";
	}
	elseif (trim($nilai_ips) == ""){
		echo "Nilai belum diisi, isi dengan benar";
	}
	elseif (trim($nilai_uan) == ""){
		echo "Nilai belum diisi, isi dengan benar";
    }
	else {
        $sqlSimpan="INSERT into pendaftaran_nilai (no_pendaftaran, nilai_agama, nilai_bhs_indo, nilai_bhs_ing, nilai_mtk, nilai_ipa, nilai_ips, nilai_uan) values ('$no_pendaftaran','$nilai_agama','$nilai_bhs_indo','$nilai_bhs_ing','$nilai_mtk','$nilai_ipa','$nilai_ips','$nilai_uan')";
