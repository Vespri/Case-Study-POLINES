					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								...
								<div class="shopping_cart"><a href="Login php/act-mahasiswa2.php"><i class="fa fa-users" aria-hidden="true"></i></a></div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Hasil Pendaftaran Mahasiswa Baru</h2>
						
						<div class="section_subtitle"><p>
						<table width="600" border="1">
  						<tr>
 							<td bgcolor="#14bdee" style="color:white" width="50">No</td>
    						<td bgcolor="#14bdee" style="color:white" width="200">No Pendaftaran</td>
							<td bgcolor="#14bdee" style="color:white" width="600">Nama</td>
							<td bgcolor="#14bdee" style="color:white" width="300">Jenis Kelamin</td>
    						<td bgcolor="#14bdee" style="color:white" width="400">Sekolah Asal</td>
							<td bgcolor="#14bdee" style="color:white" width="200">Status</td>
							<td bgcolor="#14bdee" style="color:white" width="200">Action</td>
						</tr>
						<?php
						include "koneksi.php";
						$sql="SELECT pendaftaran.*, pendaftaran_nilai.* from pendaftaran, pendaftaran_nilai where pendaftaran.no_pendaftaran=pendaftaran_nilai.no_pendaftaran  order by pendaftaran.no_pendaftaran";
						...
						$no++;
						$total = $data["nilai_agama"]+$data["nilai_bhs_indo"]+$data["nilai_bhs_ing"]+$data["nilai_mtk"]+$data["nilai_ipa"]+$data["nilai_ips"]+$data["nilai_uan"];
						$total1 = $total/7;

						if($total1 >= 75.0){
							$status = "Diterima";
						}elseif (($total1 < 75.0) && ($total1 >= 50.0)){
							$status = "Cadangan";
						}else {$status = "Ditolak";}
						...
						<td style="color:black"><a href="mahasiswa.php?id=<?php echo $data['id'];?>" target = "self">Next</a></td>
						</tr>
						<?php
						}
						?>
						...
						<div class="section_subtitle"><p>Bagi mahasiswa baru dengan Status "Diterima" harap menginputkan ulang data diri dengan mengklik Next di Field Action</p></div>
						<div class="section_subtitle"><p>Bagi mahasiswa baru dengan Status "Cadangan" harap menunggu konfirmasi selanjutnya</p></div>
						<div class="section_subtitle"><p>Peringatan : Tombol Next pada Field Action hanya untuk calon mahasiswa dengan status "Diterima"</p></div>
					</div>
				</div>
			</div>
