				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Register Anda Berhasil</div>
							<form class="comment_form" method="post" action="login-mahasiswa.php">
								<div>
									<input type="submit" name="Submit" class="comment_button trans_200" value="Login Now">
								</div>
							</form>
						</div>
					</div>
...
if($_POST){
    ...
    elseif (trim($password) == ""){
        ...
        $sqlSimpan="INSERT into mahasiswa (nama, user_id, password) values ('$nama','$userid','$password')";
        mysql_query($sqlSimpan,$konek) 
        or die ("Query simpan salah : ".mysql_error());
    }
}
else {
    include "daftar-mahasiswa.php";
}
?>