			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Data Calon Mahasiswa yang telah Mendaftar</h2>
						...
						<table width="600" border="1">
  						<tr>
							...
							<td bgcolor="#14bdee" style="color:white" width="100">Lulus Seleksi</td>
						...
						<td style="color:black"> <?php echo $lulus;?></td>
						<td><a href = "mahasiswaEdit2.php?id=<?php echo $data['id'];?>"target = "self">Edit</a></td>
                        <td><a href = "mahasiswaDelete2.php?id=<?php echo $data['id'];?>"target = "self">Hapus</a></td>
						</tr>
						<?php
						}
						?>
						...
						<div class="section_subtitle"><p>Note : Calon Mahasiswa dengan Status "Daftar" artinya masih belum resmi diterima</p></div>
						<div class="section_subtitle"><p>Jumlah Calon Mahasiswa yang mendaftar : <?php echo $no; ?></p></div>
						<div class="section_subtitle"><p>Data Mahasiswa Baru<a href="page-admin.php" style="color: #14bdee"> Next</a></p></div>
					</div>
				</div>
			</div>
