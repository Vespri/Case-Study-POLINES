				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Anda Berhasil Login</div>
							<form class="comment_form" method="post" action="daftar_mahasiswa.php">
								<div>
                                <?php
                                $random = rand(0,999999);
                                ?>
                                    <div class="form_title">Nomor Pendaftaran Anda = <a href = "#"><?php echo $random; ?></a></div>
                                    <div class="form_title">Pemberitahuan : Tolong ingat nomor pendaftaran yang sudah diberikan</div>
                                    <div class="form_title">Silakan lanjut ke Form Pendaftaran</div>
                                </div>
                                <div>
